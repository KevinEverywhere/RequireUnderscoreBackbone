...
<body>
	<div class="whitenCenter">
		<h1>Require -> Underscore -> Backbone -> JQuery</h1>
		<h3>By <a href="mailto:kevin@planetkevin.com?subject=Work or Resume Question">Kevin Ready</a></h3>
		<p>
			<a href="main.php">THIS EXAMPLE</a>
			presents a single page application which uses the following frameworks and techniques.
		</p>
		<ul>
			<li><a href="http://requirejs.org/">Require</a>: Module Loader for Application </li>
			<li><a href="http://jquery.com/">JQuery</a>: Base Utility, Selector and Browser Management</li>
			<li><a href="http://underscorejs.org/">Underscore</a>: Templating and General Purpose Utility</li>
			<li><a href="http://backbonejs.org/">Backbone</a>: Class Definition and Application Control</li>
			<li>Responsive Design: Feature and Resolution Based Coding</li>
			<li>Localization: A Backbone Based Solution for Localization</li>
			<li>Script Injection: Safe Cross Domain Loading of Foreign URL Assets</li>
		</ul>
		<h2>Frameworks and Techniques</h2>
				<h3>Framework selection</h3>
				<p>Each of the frameworks used serves a specific function for the application. Some individual full-featured frameworks, along with their accompanying CSS solutions, static or dynamic, may address all of the functions served by the combination used here. These were chosen due to their integration and wide community embrace and support. Among the salient features that a similar solution would want to address are module loading, templating, access to utility features like DOM selecting, object defining and populating, asynchronous data loading and localization.</p>
				<h3>Responsive Design in a Single Page Application</h3>
			<p>
	...
	<h3>Models and Collections</h3>
		<p>These are defined on the Backbone site and elsewhere. Any processing of data should take place within the model, including value changes, as reflected in events. </p>
	<h3>Views</h3>
	<p>
	...
	<h3>Libs, Scripts, Styles and Templates</h3>
	<p>
	...
	<h3>Links</h3>
	<p>
		<a href="index.php.txt">Text view of the Live Document</a>  - | -
		<a href="RequireUnderscoreBackbone.zip">ZIP source code</a>
	</p>
	<h3>All content created, copied or modified by <a href="mailto:kevin@planetkevin.com?subject=Work or Resume Question">Kevin Ready</a></h3>
	<p>&nbsp;
	</p>
